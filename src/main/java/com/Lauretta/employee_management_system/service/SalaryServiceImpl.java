...
import com.Lauretta.employee_management_system.exception.EmployeeNotFoundException;
...
public class SalaryServiceImpl implements SalaryService {
    ...
    public void updateSalary(SalaryDto salaryDto) {
        ...
        Employee employee = employeeRepository.findById(salaryDto.getEmployeeId())
                .orElseThrow(() -> new EmployeeNotFoundException("Employee not found with id: " + salaryDto.getEmployeeId()));
